...
{		
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			String file_name = (new SimpleDateFormat("yyyy_MM_dd_HH_mm_ss")).format(new Date(System.currentTimeMillis()));
			...
			{				
				...
				try 
			    {			    	
			    	BufferedWriter bw_1 = new BufferedWriter(new FileWriter(file_name + "_aufgaben.doc", true)); 
			    	BufferedWriter bw_2 = new BufferedWriter(new FileWriter(file_name + "_loesungen.doc", true)); 
			...
			//System.out.println(this.min_no_of_ops + " + " + (no_of_ops - this.min_no_of_ops) + "; POS: " + pos_of_equals_sign + " ; pos_unbekannte: " + pos_of_unknown);
		} 
	...
	public void stateChanged(ChangeEvent e)
    {
        ...
        {        	
        	this.no_of_sim = (int)Double.valueOf((this.no_of_sim_spinner).getValue().toString()).doubleValue();        	
        }
        
        else if(o==this.no_of_operand_min_spinner)
        {         	
        	this.min_no_of_ops = (int)Double.valueOf((this.no_of_operand_min_spinner).getValue().toString()).doubleValue();
        	this.max_no_of_ops = (int)Double.valueOf((this.no_of_operand_max_spinner).getValue().toString()).doubleValue();
        ...
        {        	    	
        	this.min_add_sub_value = (int)Double.valueOf((this.add_sub_von_spinner).getValue().toString()).doubleValue();
        	this.max_add_sub_value = (int)Double.valueOf((this.add_sub_bis_spinner).getValue().toString()).doubleValue();        	
        ...
        {        	    	
        	this.min_multiplication_value = (int)Double.valueOf((this.multiplication_von_spinner).getValue().toString()).doubleValue();
        	this.max_multiplication_value = (int)Double.valueOf((this.multiplication_bis_spinner).getValue().toString()).doubleValue();
